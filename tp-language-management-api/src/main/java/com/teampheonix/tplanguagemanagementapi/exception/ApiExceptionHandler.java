package com.teampheonix.tplanguagemanagementapi.exception;

import com.teampheonix.tplanguagemanagementapi.model.ErrorDto;
...
public class ApiExceptionHandler {
    ...
    private Map<ApiErrorCodes,ErrorDto> registerErrorCodeMap() {
        ...
        errorCodeMap.put(ApiErrorCodes.UNAUTHORIZED_ERROR, new ErrorDto("4000", "Unauthorized Access"));
        errorCodeMap.put(ApiErrorCodes.UNAUTHORIZED_ACCESS_ERROR, new ErrorDto("4001", "You don't have required access to perform the operation"));
        errorCodeMap.put(ApiErrorCodes.INVALID_REQUEST, new ErrorDto("4002", "Invalid Request"));
        errorCodeMap.put(ApiErrorCodes.CONTENT_NOT_FOUND, new ErrorDto("4003", "Content Not Found"));
